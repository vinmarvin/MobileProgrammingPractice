        ...
        builder: (context, setStateDialog) {
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                const Text('Tindakan ini tidak bisa dibatalkan. Semua data riwayat fokus, poin, dan koleksi tanaman akan terhapus selamanya.\n\nMasukkan password untuk konfirmasi:'),
                ...
                if (authProvider.errorMessage != null && isDeleting == false)
                  Padding(
            ...
            actions: [
              ...
              ElevatedButton(
                style: ElevatedButton.styleFrom(backgroundColor: Colors.red),
                onPressed: (passwordCtrl.text.isEmpty || isDeleting) 
                    ? null 
                    : () async {
                        setStateDialog(() => isDeleting = true);
                        final auth = context.read<AuthProvider>();
                        final success = await auth.deleteAccount(passwordCtrl.text);
                      ...
                      Container(
                        ...
                        decoration: const BoxDecoration(
                          gradient: LinearGradient(
                            colors: [AppColors.primaryDarker, AppColors.primaryLight],
                          ),
                        ),
